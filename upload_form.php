	...
	<form action="article.php" method="post" enctype="multipart/form-data">
		...
		<div class="category">
			<label for="author"><b>Category : </b></label>
			 <select name="type1">
			  ...
			  <option value="Miscellaneous" id="Op">Miscellaneous</option>
			  </select>
		...
		<div class="description">
			<div>
				...
				<textarea name="description" rows="6" cols="100" placeholder="Write your article in html" style="font-size: 15px;"></textarea>
			</div>
		</div>
