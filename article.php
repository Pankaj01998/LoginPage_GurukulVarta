...
<body>
	...
	<section class="mainBody">
		...
		$sql = "INSERT INTO articles (author, author_image, designation, title, category, description, article_image, date,num_of_visitors) VALUES ('$a1', '$a2', '$a3', '$a4', '$a5', '$a6', '$a7', '$a8',0 )";
